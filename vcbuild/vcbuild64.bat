...
copy /y libndtypes-0.2.0b2.lib ..\vcbuild\dist64
copy /y libndtypes-0.2.0b2.dll ..\vcbuild\dist64
copy /y libndtypes-0.2.0b2.dll.lib ..\vcbuild\dist64
copy /y libndtypes-0.2.0b2.dll.exp ..\vcbuild\dist64
